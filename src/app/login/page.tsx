    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          <img src="/logo.png" alt="Logo" className="w-12 h-12 rounded-xl mx-auto mb-4" />
          <h1 className="text-2xl font-bold tracking-tight">Fleet Manager</h1>
          <p className="text-zinc-500 mt-1 text-sm">Sign in to manage your OpenClaw instances</p>
        </div>
        <button
          onClick={handleLogin}
